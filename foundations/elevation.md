...
Elevation uses the shared shadow ladder to show surface depth, interaction, and focus without page-local shadow values. The definitions are in the [global stylesheet](design-tokens.md), and the public Card mapping is in [Card](../components/card.md).
