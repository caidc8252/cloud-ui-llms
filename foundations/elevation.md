...
Elevation uses the shared shadow ladder to show surface depth, interaction, and focus without page-local shadow values. The definitions are in the [global stylesheet source](../../src/components/styles/index.css); the public Card mapping is in [Card](../../src/components/ui/primitives/card.tsx), and application constraints are in the [portal page-style rule](../../../../.claude/team-rule/coding-rules/ui_ui-and-pages.md).
...
Keep `shadow-cta` inside the components that define primary, danger, active, or selected emphasis, such as [Button](../../src/components/ui/primitives/button.tsx), [Switch](../../src/components/ui/primitives/switch.tsx), and [StepIndicator](../../src/components/ui/recipes/step-indicator.tsx).
